...
CREATE POLICY IF NOT EXISTS "Users can view project documents"
ON public.documents
AS PERMISSIVE
FOR SELECT
TO authenticated
...
CREATE POLICY IF NOT EXISTS "Admins can manage documents bucket"
ON storage.objects
AS PERMISSIVE
FOR ALL
TO authenticated
...
CREATE POLICY IF NOT EXISTS "Users can read their project documents"
ON storage.objects
AS PERMISSIVE
FOR SELECT
TO authenticated
