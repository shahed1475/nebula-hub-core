...
import { Cloud, Users, TrendingUp, Sparkles, ArrowRight, CheckCircle2 } from "lucide-react";
...
const CloudAndDevOps = () => {
  ...
  const benefits = [
    { icon: Users, title: "Who Needs It?", description: "Organizations that rely on digital platforms, fast deployments, or global-scale applications such as SaaS companies, e-commerce, and enterprises." },
    { icon: TrendingUp, title: "Why They Need It?", description: "Traditional hosting and manual deployments are risky, slow, and costly. Cloud & DevOps enable security, automation, and performance." },
    { icon: CheckCircle2, title: "How It Helps?", description: "It ensures reliability with CI/CD pipelines, containerization, and cloud scaling. Businesses benefit from faster delivery, reduced downtime, and lower costs, while keeping data secure and applications always available." }
  ];
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-muted-foreground mb-8 leading-relaxed">
              Modernize your infrastructure with cloud migration, CI/CD automation, and DevOps 
              practices that ensure reliability, security, and rapid deployment.
            </p>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-muted-foreground">
                Enterprise-grade infrastructure and automation solutions
              </p>
            </div>
        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          >
            ...
            <p className="text-muted-foreground mb-8 max-w-2xl mx-auto">
              Let's modernize your infrastructure with cloud migration, DevOps automation, and 
              scalable solutions that ensure security and reliability.
            </p>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Link to="/quote">
